...
import (
	...
	"github.com/mhmtnzly/bookings/internal/forms"
...
// Reservation renders the a reservation page and displays form
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	var empytReservation models.Reservation
	data := make(map[string]interface{})
	data["reservation"] = empytReservation
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(fmt.Sprintf("sdate: % and edate: %", start, end)))
}
...
// PostAvailabilityJSON handler request the search availability page
